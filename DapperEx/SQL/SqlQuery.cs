...
namespace DapperEx
{
    public abstract class SqlQuery
    {
        ...
        internal virtual string Delete(int id)
        {

            var sqlStr = "";
            sqlStr = string.Format(" delete from {0} where id ={1}", this._ModelDes.TableName, id);
            return sqlStr;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        internal virtual string Get(int id)
        {

            var sqlStr = "";
            sqlStr = string.Format(" select * from {0} where id ={1}", this._ModelDes.TableName, id);
            return sqlStr;
        ...
        internal virtual string CountSql
        {
            get
            {
                return string.Format("SELECT COUNT(1) DataCount FROM {0} {1}", this._ModelDes.TableName, this.WhereSql);
            }
        }
